 ...
 * While this is the class that makes doubly-linked list functions available, you 
 * should implement the DLLNode class to do the bulk of the behaviour using recursion.  
 * You will have very similar method names in your node class which this class calls 
 * upon if this class's root node is valid.
 *
 * You must implemement these methods using recursion.
*/
