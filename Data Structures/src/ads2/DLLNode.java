...
/* This class is used within the DoublyLinkedList data collection as the link nodes
 * This is a doubly linked list and not just a singly linked list
 */
public class DLLNode
{
  ...
  {
    return(next.data==null?1:1+next.GetNoOfItems());  
  }
  ...
  public DLLNode AddItem(String value)
  {
  ...
  public String GetNodeInfo(int index)
  {
      if (index == 0)
      {
        String val = "Previous: " + (GetPreviousNode().data).toString() + " Next: " + (GetNextNode().data).toString() + " Data: " + (GetDataItem()).toString();
        return val;        
      }
      else
      {
